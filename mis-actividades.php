...
<head>
    <meta charset="UTF-8">
    <title>Mis Actividades | SUVA</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="/SUVA-LOGIN/styles-dashboard.css">
</head>

<!-- ✅ Clase específica para ajustar SOLO esta página -->
<body class="mis-actividades">
...
<header class="header">
    <div class="header-left">
        ...
        <img src="/SUVA-LOGIN/logo.png" class="logo" alt="SUVA">
    </div>
    ...
    <div class="header-right">
        <div class="user-text">
            ...
            <span class="user-links">
                <a href="/SUVA-LOGIN/perfil.php">Mi Perfil</a> |
                <a href="/SUVA-LOGIN/logout.php">Cerrar sesión</a>
            </span>
        </div>
        <img src="/SUVA-LOGIN/user.png" class="user-avatar" alt="Usuario">
    </div>
</header>
...
<div class="layout">
    ...
    <aside class="sidebar">
        <ul>
            ...
            <li class="active"><a href="/SUVA-LOGIN/mis-actividades.php">Mis actividades</a></li>
    ...
    <main class="content">
        ...
        <p class="subtitle">Actividades asignadas y su estado</p>
